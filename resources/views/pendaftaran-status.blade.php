                    ...
                    <div class="my-6">
                        <form method="post" action="{{ route('daftar') }}" class="flex flex-row items-center">
                            ...
                            <div class="mt-7 flex justify-center items-center">
                                <button type="submit"
                                    class="inline-flex items-center justify-center px-6 py-3 rounded-full bg-purple-900 hover:bg-white hover:border hover:border-purple-900 text-white hover:text-black text-lg text-center transition duration-300">
                                    Kirim Bukti Pembayaran
                                </button>
                            </div>
                        </form>
                    </div>
                    <span class="font-semibold text-left text-sm text-zinc-400">
